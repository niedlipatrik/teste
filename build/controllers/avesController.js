...
class GamesController {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const aves = yield database_1.default.query('SELECT * FROM aves WHERE id = ?', [id]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('UPDATE aves set ? WHERE id = ?', [req.body, id]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM aves WHERE id = ?', [id]);
